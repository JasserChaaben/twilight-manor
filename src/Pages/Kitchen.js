      ...
      {!showPopup && (
        <div className="kitchen-content">
          {level <= 2 ? (
            ...
            <h3>
              As {name} searches through the kitchen, they notice a strange,
              dusty cookbook left open on the counter. The pages are worn, and
              one passage is underlined in dark ink: "The feast was never
              finished... It waits where the table is set." Flipping the page
              reveals an old diagram of the mansion’s dining room. A small
              sketch marks a specific spot on the table. The message is
              clear—something important remains there, waiting to be found.
            </h3>
          )}
          {level != 2 ? (
