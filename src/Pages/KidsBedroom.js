...
function KidsBedroom({  name ,level, LevelUp }) {
  ...
  return (
    <div className="kids-bedroom-container">
      ...
      {!showPopup && <div className="kids-bedroom-content">
      {level<=5?  <h3>
